...
public class SortedListTests
{
    ...
    {
        var sut = new SortedList<int> { 1, 3, 7 };
        var count = sut.Count;
    ...
    [Test]
    public void Add_Should_Insert5AtIndex2_When_5Exists()
    {
        var sut = new SortedList<int> { 1, 3, 5, 7 };
        var count = sut.Count;
    ...
    [Test]
    public void Add_Should_Insert9_When_9IsSameAsMaxValue()
    {
    ...
    {
        var sut = new SortedList<int> { 2, 3, 7 };
        var count = sut.Count;
    ...
    [Test]
    public void Add_Should_InsertItemIndex0_When_ValueIsSameAsMinValue()
    {
        var sut = new SortedList<int> { 2, 3, 7 };
        var count = sut.Count;
