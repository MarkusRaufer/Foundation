...
public class CircularArrayTests
{
    ...
    public void Add_Should_Have3Elements_When_CapacityIs3AndAdded3()
    {
        // Arrange
        var capacity = 3;
        var sut = new CircularArray<int>(capacity);
    ...
    public void Ctor_Should_HaveLengthOfThree_When_AddedArrayWithLength3()
    {
        ...
        // Act
        var sut = new CircularArray<int>(numbers);

        // Assert
        sut.Length.ShouldBe(numbers.Length);
        var values = sut.ToArray();
    ...
    public void Head_Should_ReturnOne_When_CapacityIs3AndAdded4()
    {
        // Arrange
        var capacity = 3;
        var sut = new CircularArray<string>(capacity);
        sut.Add("one");
        sut.Add("two");
        sut.Add("three");
        sut.Add("four");
