...
{
    [TestFixture]
    public class EquatableBagTests
    {
        [Test]
        ...
        public void Cast_Should_ImplicitlyCastToEquatableArray_When_EquatableBagIsMethodArgument()
        {
            ...
            bool method(EquatableBag<int> sut)
            {
        ...
        public void Cast_Should_ImplicitlyCastToArray_When_CastFrom_EquatableBag_To_Array()
        {
            ...
            int[] ints = EquatableBag.New(array);
        ...
        public void Equals_Should_ReturnFalse_When_SameSize_SameValues_DifferentPositions_OfElementsAreSame()
        {
            ...
            var eqArr1 = EquatableBag.New(arr1);
            var eqArr2 = EquatableBag.New(arr2);
        ...
        {
            var eqArr1 = EquatableBag.New(1, 2, 3);
            var eqArr2 = EquatableBag.New(3, 2, 1);
        ...
        {
            var eqArr1 = EquatableBag.New(1, 2, 3);
            var eqArr2 = EquatableBag.New(1, 2, 3);
