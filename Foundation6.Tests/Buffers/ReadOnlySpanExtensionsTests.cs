...
namespace Foundation.Buffers
{
    ...
    public class ReadOnlySpanExtensionsTests
    {
        ...
        [Test]
        public void IndexesOf_Should_Return_Indices_When_Using_Value_As_Separator()
        {
            var sut = "123.4567.89".AsSpan();
        ...
        [Test]
        public void IndexesOf_Should_Return_Indices_When_Using_Values_As_Separator()
        {
            var sut = "123_4567.89".AsSpan();
            var indices = sut.IndexesOf('.', '_').ToArray();
            Assert.AreEqual(2, indices.Length);
