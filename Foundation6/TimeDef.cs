...
public abstract record TimeDef
{
    ...
    public record Day(UniqueArrayValue<int> DayOfMonth) : TimeDef;
    public record Days(int Quantity) : TimeDef;
    public record Difference(TimeDef Lhs, TimeDef Rhs) : TimeDef;
    public record Hour(UniqueArrayValue<int> HourOfDay) : TimeDef;
    public record Hours(int Quantity) : TimeDef;
    public record Minute(UniqueArrayValue<int> MinuteOfHour) : TimeDef;
    public record Minutes(int Quantity) : TimeDef;
    public record Month(UniqueArrayValue<Foundation.Month> MonthOfYear) : TimeDef;
    ...
    public record Weekday(UniqueArrayValue<DayOfWeek> DayOfWeek) : TimeDef;
    public record WeekOfMonth(DayOfWeek WeekStartsWith, UniqueArrayValue<int> Week) : TimeDef;
    public record Weeks(int Quantity, DayOfWeek WeekStartsWith) : TimeDef;
    public record Year(UniqueArrayValue<int> YearOfDate) : TimeDef;
