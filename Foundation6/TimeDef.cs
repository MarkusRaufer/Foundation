...
public abstract record TimeDef
{
    ...
    public record Day(UniqueOnlyArray<int> DayOfMonth) : TimeDef;
    public record Days(int Quantity) : TimeDef;
    public record Difference(TimeDef Lhs, TimeDef Rhs) : TimeDef;
    public record Hour(UniqueOnlyArray<int> HourOfDay) : TimeDef;
    public record Hours(int Quantity) : TimeDef;
    public record Minute(UniqueOnlyArray<int> MinuteOfHour) : TimeDef;
    public record Minutes(int Quantity) : TimeDef;
    public record Month(UniqueOnlyArray<Foundation.Month> MonthOfYear) : TimeDef;
    ...
    public record Weekday(UniqueOnlyArray<DayOfWeek> DayOfWeek) : TimeDef;
    public record WeekOfMonth(DayOfWeek WeekStartsWith, UniqueOnlyArray<int> Week) : TimeDef;
    public record Weeks(int Quantity, DayOfWeek WeekStartsWith) : TimeDef;
    public record Year(UniqueOnlyArray<int> YearOfDate) : TimeDef;
