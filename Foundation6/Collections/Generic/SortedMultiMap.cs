    ...
    where TKey : notnull
{
    ...
    public SortedMultiMap() : this(new SortedDictionary<TKey, ICollection<TValue>>(), () => new List<TValue>())
    {
    }

    public SortedMultiMap(IComparer<TKey>? comparer)
        : this(new SortedDictionary<TKey, ICollection<TValue>>(comparer), () => new List<TValue>())
    {
    }

    public SortedMultiMap(IDictionary<TKey, ICollection<TValue>> dictionary)
        : this(new SortedDictionary<TKey, ICollection<TValue>>(dictionary), () => new List<TValue>())
    {
    }
    ...
    public SortedMultiMap(Func<ICollection<TValue>> valueCollectionFactory)
        : this(new SortedDictionary<TKey, ICollection<TValue>>(), valueCollectionFactory)
    {
    }

    public SortedMultiMap(IComparer<TKey>? comparer, Func<ICollection<TValue>> valueCollectionFactory)
        : this(new SortedDictionary<TKey, ICollection<TValue>>(comparer), valueCollectionFactory)
    {
    }
    ...
    public SortedMultiMap(
        ...
        : this(new SortedDictionary<TKey, ICollection<TValue>>(dictionary), valueCollectionFactory)
    {
    }
    ...
    public SortedMultiMap(
        ...
        Func<ICollection<TValue>> valueCollectionFactory)
        : this(new SortedDictionary<TKey, ICollection<TValue>>(dictionary, comparer), valueCollectionFactory)
    {
    }
